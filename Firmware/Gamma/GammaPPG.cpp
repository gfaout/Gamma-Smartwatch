// Note:  Most of this code was taken from the KickJrPPG repository
// From the author listed below.

/*
 FILENAME:      GammaPPG.cpp
...
//bool GammaPPG::getLEDStatus() const
...
//void GammaPPG::setLEDCurrent(uint8_t val)
...
//uint8_t GammaPPG::getLEDCurrent() const
//
...
//void GammaPPG::balanceLEDCurrent()
//
...
//void GammaPPG::setTIAGain(uint8_t gain)
...
//uint8_t GammaPPG::getTIAGain() const
//
...
//uint16_t GammaPPG::getTIA() const
//
...
//void GammaPPG::setPPGGain(uint8_t gain)
//gain      value between 0-255 to set resistance of digital potentiometer
//
...
//uint8_t GammaPPG::getPPGGain() const
...
//uint16_t GammaPPG::getPPG() const
